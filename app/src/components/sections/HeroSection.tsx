        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="relative order-1 lg:order-2">
            ...
            <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 lg:left-8 lg:translate-x-0 z-20 transition-transform hover:scale-105 duration-300">
              <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl px-6 py-4 border border-[#5a6b91]/20 hover:border-[#28338d]/30 transition-all duration-300">
                <div className="flex items-center gap-3">
                  <div className="flex -space-x-2">
                    <div className="font-serif w-12 h-12 rounded-full bg-linear-to-br from-[#28338d] via-[#3a4d8f] to-[#5a6b91] flex items-center justify-center text-white font-bold text-base border-2 border-white shadow-lg">
                      EM
                    </div>
                  </div>
                  <div className="text-left">
                    <div className="font-serif text-md font-bold bg-linear-to-r from-[#28338d] to-[#5a6b91] bg-clip-text text-transparent">
                      {DOCTOR_NAME}
                    </div>
                    <div className="text-xs text-[#9c9c9a] font-medium">
