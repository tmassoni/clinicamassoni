---
title: 'Traumatismo facial: quando a batida no rosto vira fratura'
metaDescription: 'Nem todo trauma de face é fratura, mas alguns sinais exigem avaliação imediata. Veja o que indica fratura de mandíbula, maxila ou órbita.'
slug: 'traumatismo-facial-fraturas'
publishDate: '2026-08-04'
lastModified: '2026-08-04'
primaryKeyword: 'traumatismo facial'
secondaryKeywords:
  - 'fratura de mandíbula'
  - 'traumatologia buco-maxilo-facial'
  - 'fratura facial Cascavel'
  - 'trauma de face'
...
faqs:
  - question: 'Como sei se quebrei um osso do rosto ou é só inchaço?'
    answer: 'Não dá para saber com segurança sem exame. Alguns sinais tornam a fratura provável: mordida que mudou, dentes que não encaixam como antes, dificuldade ou dor para abrir a boca, dormência em uma região da face, degrau palpável no contorno ósseo, visão dupla ou assimetria. Qualquer um deles indica avaliação com exame de imagem no mesmo dia.'
  - question: 'Toda fratura de face precisa de cirurgia?'
    answer: 'Não. Fraturas sem deslocamento e que não alteram a mordida podem ser tratadas de forma conservadora, com dieta adaptada, repouso funcional e acompanhamento. A cirurgia é indicada quando há deslocamento, quando a mordida foi alterada, ou quando a função e a forma não se restabelecem sem reposicionar os fragmentos.'
  - question: 'Qual é o osso da face que mais fratura?'
    answer: 'A mandíbula está entre os mais acometidos, junto com os ossos nasais e o complexo zigomático — o osso da maçã do rosto. As causas mais frequentes são acidentes de trânsito, quedas, agressões e traumas esportivos. O padrão da fratura muda conforme a direção e a intensidade do impacto.'
  - question: 'Vou ficar com a boca amarrada?'
    answer: 'Na maior parte dos casos, não por muito tempo. As técnicas atuais usam fixação interna com placas e parafusos de titânio, que estabilizam os fragmentos e permitem função precoce. O bloqueio maxilomandibular prolongado ficou restrito a situações específicas, e frequentemente se usam elásticos guias em vez de bloqueio rígido.'
  - question: 'As placas de titânio precisam ser removidas depois?'
    answer: 'Geralmente não. O titânio é biocompatível e as placas costumam permanecer sem causar problema. A remoção é indicada em situações específicas — exposição, infecção, desconforto persistente ou, em pacientes jovens, interferência no crescimento — e é uma decisão tomada caso a caso, não uma rotina.'
  - question: 'Quanto tempo leva a recuperação?'
    answer: 'A consolidação óssea leva em torno de seis semanas, com retorno gradual à dieta normal ao longo desse período e acompanhamento por alguns meses. O inchaço reduz de forma importante nas primeiras duas semanas. O prazo real varia com o osso envolvido, o tipo de fratura e as condições de saúde do paciente.'
---

_A pergunta mais difícil depois de uma batida forte no rosto é justamente a mais simples: preciso ir agora ou dá para esperar amanhã?_
...
5. **Se houve dente avulsionado**, siga as orientações de [dente quebrado](/blog/dente-quebrado-o-que-fazer) — o dente pode ser recuperável, e o tempo conta.
...
Nem todo trauma termina quando o osso solda. É comum que a reabilitação siga com tratamento de dentes fraturados, avaliação de dentes que sofreram o impacto e podem perder vitalidade meses depois, e, quando houve perda dentária, planejamento de [implantes](/blog/implante-dentario-passo-a-passo) ou prótese.
